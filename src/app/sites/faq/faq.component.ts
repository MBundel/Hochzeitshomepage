...
export class FaqComponent {
  ...
  faqList = [
    ...
    {
      frage: 'Was macht dir beim Fotografieren am meisten Spaß, bzw. was  zeichnet deine Fotografie aus?',
      antwort: 'Am liebsten begleite ich eine Hochzeit von Start bis Ende. In den Momenten, bei denen sich die Menschen' +
    ...
    },
    {
      ...
      antwort: 'Ich rechne nach Stunden oder Tagessatz. Es handelt sich dann um einen Festpreis, es kommen keine weiteren ' +
        'Gebühren o.ä. hinzu.'
    },
    {
      frage: 'Was ist in dem Preis enthalten?',
      antwort: 'Natürlich, dass ich vor Ort bin und Bilder schieße, die Nachbearbeitung ist selbstverständlich bereits ' +
        'inklusive im Preis einhalten.'
    },
    {
      frage: 'Wie viele Bilder bekommen wir?',
      antwort: 'Das kommt natürlich darauf an, wie lange ich vor Ort bin und was alles passiert. Bei einem reinen  ' +
    ...
    },
    {
      ...
      antwort: 'Manchmal ist das Licht so ungünstig, dass es in Farbe furchtbar aussieht. In Schwarz-Weiß sieht das Bild dann' +
    ...
    },
    {
      ...
      antwort: 'Aktuell erhaltet ihr nach Bezahlung einen WeTransfer-Link. Bei diesem habt ihr eine Woche Zeit, alle' +
    ...
    },
    {
      ...
      antwort: 'Meine Kamera produziert, RAW- und keine JPG-Dateien beim Fotoschießen. Diese sind um einiges besser für die' +
    ...
    },
    {
      ...
      antwort: 'In der Regel speichere ich die Bilder auf einer externen Festplatte so lange wie möglich. Nach 10 Jahren musste ich dann' +
    ...
    },
    {
      ...
      antwort: ' Der Ablauf sieht so aus: Fotoshooting - Nachbearbeitung - Bezahlung - Aushändigung der Bilder. So ist jeder motiviert, ' +
        'möglichst schnell seinen Soll zu erfüllen '
    },
    {
      frage: 'Was passiert, wenn du krank wirst?',
      antwort: 'Das ist bisher noch nie vorgekommen. Fall es doch vorkommen sollte, kommt eine Ersatzperson, die auch fotografisch talentiert ist. '
    },
    {
      frage: 'Darf ich dich weiterempfehlen?',
      antwort: 'Ich finde das ja lieb, dass vorher gefragt wird. Ja na klar, gerne!'
    },
    {
      frage: 'Machst du das hauptberuflich?',
      antwort: 'Ich habe mich das im Studium gefragt, ob ich das hauptberuflich machen möchte, da die Nachfrage nach mir auch den Einstieg einfach gemacht hätte. ' +
